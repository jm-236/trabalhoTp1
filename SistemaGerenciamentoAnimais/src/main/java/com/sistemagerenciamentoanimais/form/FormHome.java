 ...
 */
package com.sistemagerenciamentoanimais.form;

import com.sistemagerenciamentoanimais.component.Item;
import com.sistemagerenciamentoanimais.event.EventAnimal;
import com.sistemagerenciamentoanimais.model.Animal;
import com.sistemagerenciamentoanimais.swing.mainpanel.ScrollBar;
...
public class FormHome extends javax.swing.JPanel {
    ...
    public void showAnimal(Animal data) {
        lbAnimalName.setText(data.getNome());
        //txtDescription.setText(data.getDescription());
        lbData.setText(data.getData().toString());
        lbGenero.setText(data.getGenero());
        lbIdade.setText("Idade: "+ data.getIdade());
        lbRaca.setText(data.getRaca());
        lbPorte.setText(data.getPorte());
        lbLocal.setText("Local: "+data.getLocal());
        lbPeso.setText("Peso: "+data.getPeso());
        lbNascimento.setText("Data de Nascimento: "+data.getDataNascimento());
    ...
    private void initComponents() {
        ...
        panelItem = new com.sistemagerenciamentoanimais.swing.mainpanel.PanelItem();
    ...
    private com.sistemagerenciamentoanimais.swing.mainpanel.PanelItem panelItem;
